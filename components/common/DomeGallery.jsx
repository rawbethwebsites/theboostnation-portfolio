...
const DEFAULT_IMAGES = [
  ...
  {
    src: 'https://images.unsplash.com/photo-1755497595318-c2a0fe5ac3d8?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    alt: 'Digital artwork'
  },
  {
...
export default function DomeGallery({
  ...
  useEffect(() => {
    ...
    const close = () => {
      ...
      const animatingOverlayCurrent = animatingOverlay;
      const cleanup = () => {
        animatingOverlayCurrent.remove();
